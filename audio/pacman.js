...
function Start() {
    ...
    //document.getElementById("LogOut"). = true ;
    ...
    monster1Img.src = "img/m1.png"

    monster2Img = new Image();
    monster2Img.src = "img/m2.png"

    monster3Img = new Image();
    monster3Img.src = "img/m3.png"
    ...
    for (var i = 0; i < col; i++) {
        for (var j = 0; j < row; j++) {
            ...
            if (i==shape.x && j== shape.y) { //Draw pacman!
                ...
                context.drawImage(point5, center.x, center.y);
            } else if (board[i][j] == 15) {
                context.drawImage(point15, center.x, center.y);
            } else if (board[i][j] == 25) {
                context.drawImage(point25, center.x, center.y);
            }
            else if (board[i][j] == 4) {
